...
if(start>=0&&end>start){
 const bottom=` <View style={{height:84,backgroundColor:'#fff',borderTopWidth:1,borderTopColor:'#e5e7eb',flexDirection:'row',alignItems:'center',justifyContent:'space-around',paddingBottom:8}}>
...
console.log('Applied iOS default listing actions and bottom navigation.');
