(() => {
  ...
  .diili-detail-panel{width:min(560px,96vw);max-height:88vh;overflow:auto;background:#fff;border-radius:22px;padding:20px;box-shadow:0 24px 70px rgba(15,23,42,.25);overscroll-behavior:contain}
  ...
  @media(max-width:560px){
    ...
    .diili-detail-panel:before{content:'';display:block;width:42px;height:5px;border-radius:999px;background:#cbd5e1;margin:0 auto 10px}
    .diili-detail-head{position:sticky;top:-14px;z-index:4;background:#fff;margin:0 -2px 12px;padding:6px 2px 8px}.diili-detail-head h2{font-size:19px;line-height:1.25}.diili-detail-close{width:34px;height:34px;font-size:21px;flex:0 0 34px}
    .diili-detail-product{grid-template-columns:74px 1fr;gap:11px;padding:10px;border-radius:14px}.diili-detail-img,.diili-detail-fallback{width:74px;height:74px;border-radius:11px}.diili-detail-fallback{font-size:28px}.diili-detail-title{font-size:16px;line-height:1.25}.diili-detail-price{font-size:21px;margin-top:3px}.diili-detail-sub{font-size:12px;margin-top:2px}
    .diili-detail-status{margin-top:10px;padding:11px;border-radius:12px}.diili-detail-status p{font-size:13px;margin-top:6px;line-height:1.4}.diili-detail-badge{font-size:11px;padding:5px 8px}
    .diili-detail-people{grid-template-columns:1fr 1fr;gap:8px;margin-top:9px}.diili-detail-box{padding:9px 10px;border-radius:11px;min-width:0}.diili-detail-box small{font-size:11px;margin-bottom:2px}.diili-detail-box strong{display:block;font-size:13px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
    .diili-detail-steps{margin-top:12px}.diili-detail-steps h3{font-size:17px;margin-bottom:5px}.diili-step{gap:8px;padding:7px 0}.diili-step-dot{width:22px;height:22px;flex-basis:22px;font-size:11px}.diili-step-copy b{font-size:13px;line-height:1.25}.diili-step-copy span{font-size:11px;line-height:1.25}
    .diili-detail-actions{position:sticky;bottom:calc(-14px - env(safe-area-inset-bottom));z-index:5;background:#fff;margin:10px -14px calc(-14px - env(safe-area-inset-bottom));padding:10px 14px calc(10px + env(safe-area-inset-bottom));border-top:1px solid #eef2f7;gap:7px}.diili-detail-actions button{min-width:0;padding:11px 10px;font-size:13px;border-radius:10px}
  }
  @media(max-width:370px){.diili-detail-people{grid-template-columns:1fr}.diili-detail-actions{flex-direction:column}.diili-detail-actions button{width:100%}}
  `;
