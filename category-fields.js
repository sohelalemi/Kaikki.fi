(() => {
 ...
 const phoneModels={
  Apple:['iPhone 18','iPhone 18 Pro','iPhone 18 Pro Max','iPhone 17','iPhone 17 Pro','iPhone 17 Pro Max','iPhone 17 Air','iPhone 16e','iPhone 16','iPhone 16 Plus','iPhone 16 Pro','iPhone 16 Pro Max','iPhone 15','iPhone 15 Plus','iPhone 15 Pro','iPhone 15 Pro Max','iPhone 14','iPhone 14 Plus','iPhone 14 Pro','iPhone 14 Pro Max','iPhone 13','iPhone 13 mini','iPhone 13 Pro','iPhone 13 Pro Max','iPhone 12','iPhone 12 mini','iPhone 12 Pro','iPhone 12 Pro Max','iPhone 11','iPhone 11 Pro','iPhone 11 Pro Max','iPhone SE','Muu iPhone'],
  Samsung:['Galaxy S26','Galaxy S26+','Galaxy S26 Ultra','Galaxy S25','Galaxy S25+','Galaxy S25 Ultra','Galaxy S25 Edge','Galaxy S24','Galaxy S24+','Galaxy S24 Ultra','Galaxy S24 FE','Galaxy S23','Galaxy S23+','Galaxy S23 Ultra','Galaxy S23 FE','Galaxy S22','Galaxy S22+','Galaxy S22 Ultra','Galaxy S21','Galaxy S21+','Galaxy S21 Ultra','Galaxy S21 FE','Galaxy Z Fold8 Ultra','Galaxy Z Fold8','Galaxy Z Flip8','Galaxy Z Fold7','Galaxy Z Flip7','Galaxy Z Flip7 FE','Galaxy Z Fold6','Galaxy Z Flip6','Galaxy Z Fold5','Galaxy Z Flip5','Galaxy Z Fold4','Galaxy Z Flip4','Galaxy A57 5G','Galaxy A56 5G','Galaxy A55 5G','Galaxy A54 5G','Galaxy A37 5G','Galaxy A36 5G','Galaxy A35 5G','Galaxy A34 5G','Galaxy A27 5G','Galaxy A26 5G','Galaxy A25 5G','Galaxy A24','Galaxy A17 5G','Galaxy A16 5G','Galaxy A15 5G','Galaxy A14 5G','Galaxy A06','Galaxy A05s','Galaxy XCover7 Pro','Galaxy XCover7','Galaxy XCover6 Pro','Muu Galaxy'],
 ...
 function inputFor(label,key){
  if(cat.value==='Asunnot'&&key==='area') return `<input data-extra="${key}" type="number" min="1" step="1" placeholder="Esim. 11">`;
  if(cat.value==='Asunnot'&&key==='built') return `<input data-extra="${key}" type="number" min="1800" max="2100" step="1" placeholder="Esim. 2020">`;
  return `<input data-extra="${key}" placeholder="${label}">`;
 }
