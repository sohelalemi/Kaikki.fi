(() => {
 ...
 async function renderPanel(){
  ...
  try{
   ...
   panel.querySelector('.notify-all').onclick=async()=>{await B.markAllNotificationsRead();await renderPanel();await refreshBadge()};
